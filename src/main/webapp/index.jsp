	...
	<h1>Register</h1>
     ...
     <form method="post" action="register">
            <div class="form-outline mb-4">
                <input type="text" name="firstName" value="First Name" required="required" onclick="this.value=''"/><br/>
            </div>
            <div class="form-outline mb-4">
                        <input type="text" name="lastName" value="Last Name" required="required" onclick="this.value=''"/><br/>
                    </div>
            <div class="form-outline mb-4">
                <input type="text" name="email"  value="Email" required="required" onclick="this.value=''"/><br/>
            </div>
            <div class="form-outline mb-4">
                        <input type="password" name="password" value="Password"  required="required" onclick="this.value=''"/><br/>
                    </div>
        ...
        <button id="myButton" class="btn btn-primary btn-block btn-large" >Log in</button>
